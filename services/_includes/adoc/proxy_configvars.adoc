...
a|`PROXY_FORCE_STRICT_TRANSPORT_SECURITY` +
...
a|`OCIS_CLAIM_MANAGED_SPACES_CLAIMNAME` +
...
a|`OCIS_CLAIM_MANAGED_SPACES_REGEXP` +
...
a|`OCIS_CLAIM_MANAGED_SPACES_MAPPING` +
...
a|`OCIS_MULTI_INSTANCE_MEMBER_CLAIM` +
...
a|`OCIS_MULTI_INSTANCE_GUEST_CLAIM` +
...
a|`OCIS_MULTI_INSTANCE_GUEST_ROLE` +
